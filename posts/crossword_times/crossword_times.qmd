...
description: "On so-called \"descriptive\" analysis."
filters:
   - lightbox
lightbox: auto
code-fold: true
...
Now we the relative difficulty of each group of puzzles stands out. So what's the problem?
